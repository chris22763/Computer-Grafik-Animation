function addModelFromFile(select){
	...
	if (select === "tabel"){
		...
		physics.addBox(model, 4, 0.1, 2, 10);
		...
		model.rotation.x = DEG_TO_RAD * 45;
        ...
        velocityVectorWC.multiplyScalar(100);
    	physics.addCylinder(model, 0.5 , 0.5 , 3 , false, 5, velocityVectorWC);
